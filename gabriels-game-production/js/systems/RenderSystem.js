class RenderSystem extends System {
    ...
    renderUI(ctx) {
        // Integrate UI system rendering if available
        if (this.gameEngine && this.gameEngine.uiSystem && this.gameEngine.uiSystem.render) {
            try {
                this.gameEngine.uiSystem.render(ctx);
            } catch (error) {
                console.error('Error rendering UI system:', error);
            }
        }

        // Also render particle effects if available
        if (this.gameEngine && this.gameEngine.particleSystem && this.gameEngine.particleSystem.render) {
            try {
                this.gameEngine.particleSystem.render(ctx);
            } catch (error) {
                console.error('Error rendering particle system:', error);
            }
        }
    }
